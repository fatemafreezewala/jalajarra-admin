...
export const BASE_URL = "http://143.198.111.15/jalalajarra/v1/branch_admin_api/"    // DEV
export const BASE_URL_GENERAL = "http://143.198.111.15/jalalajarra/v1/branch_admin_api/";   // DEV
...
export function getProportionalFontSize(baseFontSize) {
  ...
  return Platform.OS =="ios" ? fontSizeToReturnVertical : fontSizeToReturnVertical - 1;
}
