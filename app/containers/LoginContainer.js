...
import i18n from "../locales/i18nnext";
                            ...
                            <EDRTLView style={styles.forgetView}>
                                ...
                                >
                                    <EDRTLView style={styles.rememberViewStyle}>
                                        <Icon name={this.state.remember ? "check-square" : "square"} type={'feather'} color={EDColors.text} size={18} />
...
const styles = StyleSheet.create({
    ...
    forgetView:{ alignItems: "center",marginTop: 30,justifyContent: "space-between"},
