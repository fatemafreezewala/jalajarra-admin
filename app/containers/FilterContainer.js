...
class FilterContainer extends React.Component {
    constructor(props) {
        ...
        this.filterOptions = [ strings("filterToday"), strings("filterYesterday"), strings("filterThisMonth"), strings("filterCustomRange")]
    ...
    state = {
        ...
        isLoading: false,
        isSelected: false,
        currentStartDate: this.props.route.params.startDate != "" ? this.props.route.params.startDate : new Date(),
        currentEndDate: this.props.route.params.endDate != "" ? this.props.route.params.endDate : new Date(),
        startDate: this.props.route.params.startDate != "" ?  moment(this.props.route.params.startDate.toString()).format('MM-DD-YYYY') : moment(new Date().toString()).format('MM-DD-YYYY'),
        endDate: this.props.route.params.endDate != "" ?  moment(this.props.route.params.endDate.toString()).format('MM-DD-YYYY'): moment(new Date().toString()).format('MM-DD-YYYY'),
    ...
    reset = () => {
        ...
        this.state.startDate =  moment(new Date().toString()).format('MM-DD-YYYY'),
        this.state.endDate =  moment(new Date().toString()).format('MM-DD-YYYY'),
