        ...
        return (
            ...
            >
                <View style={styles.pickerPopUp}>
                    <EDRTLText title={strings('generalSelectProfilePic')} style={styles.pickerTitle} />
                    <TouchableOpacity onPress={this.launchCamera}>
                        <EDRTLView style={styles.optionContainer}>
                            ...
                            <EDRTLText title={strings('generalCapturePhotoTitle')} style={styles.optionTitle} />
                        </EDRTLView>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={this.launchGalleryPicker}>
                        <EDRTLView style={styles.optionContainer} >
                            <Icon name="image" color={EDColors.primary} size={20} />
                            <EDRTLText title={strings('generalChoosePhotoTitle')} style={styles.optionTitle} />
                        </EDRTLView>
                    </TouchableOpacity>
                    <EDUnderlineButton
                        label={
