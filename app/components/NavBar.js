            ...
            {this.props.right
              ? <EDRTLView style={styles.rightSubContainer}>
                <TouchableOpacity
                  ...
                  <Icon type={this.props.rightIconFamily || 'material'} size={24}
...
const styles = StyleSheet.create({
  ...
  combinedViewStyle: {justifyContent:'space-evenly',flex:0.55 },
  ...
  titleContainer: { justifyContent: 'center', marginLeft: 10, marginRight: 10,alignItems: isRTLCheck() ? 'flex-end' :'flex-start', fontSize : getProportionalFontSize(18) , fontFamily : EDFonts.semibold, marginBottom:5},
