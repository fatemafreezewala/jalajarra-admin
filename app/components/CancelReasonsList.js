...
export default class CancelReasonsList extends Component {
    ...
    constructor(props) {
        ...
        this.arrayCancellationReasons = this.props.reasonList != undefined && this.props.reasonList != null ? [...this.props.reasonList,{reason: strings('orderCancellationReasonsOther'), }] : undefined
        ...
        return (
            ...
            <View style={styles.productsSummaryContainer}>
                ...
                <EDRTLText
                    ...
                    title={ this.props.isCancel != undefined && this.props.isCancel == true ? strings('orderCancellationReasonsSelectReason') : strings('orderCancellationReasonsSelectRejectReason') } />
                ...
                {this.state.shouldPerformValidation
                    ? this.state.selectedIndex == -1
                        ? <EDRTLText style={styles.errorTextStyle}
                            title={ this.props.isCancel != undefined && this.props.isCancel == true ? strings('orderCancellationReasonsPleaseSelectReason') : strings('orderCancellationReasonsPleaseSelectRejectReason') } />
                        : null
                    : null}
...
const styles = StyleSheet.create({
    ...
    dismissButton: { paddingHorizontal: 0, alignSelf: 'center', marginTop: 20, marginBottom: 10 , marginHorizontal:10,
        fontSize: getProportionalFontSize(16), 
        height : Metrics.screenHeight * 0.073,
        width : Metrics.screenWidth * 0.37,
        justifyContent:'center',
        fontFamily: EDFonts.medium, borderRadius:16},
    dismissButtonTransparent: { paddingHorizontal: 0, alignSelf: 'center', marginTop: 20, marginBottom: 10 , marginHorizontal:10,
        fontSize: getProportionalFontSize(16), 
        height : Metrics.screenHeight * 0.073,
        width : Metrics.screenWidth * 0.37,
