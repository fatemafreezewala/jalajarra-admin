                ...
                <TouchableOpacity
                    ...
                    <View>
                        <EDRTLView style={styles.buttonViewStyle}>
                            ...
                            <Icon name={this.props.iconName} size={this.props.size || 20} color={this.props.iconColor || EDColors.text} type={this.props.iconType || 'ant-design'} />
                        </EDRTLView>
                    </View>
                </TouchableOpacity>
                {/* ERROR MESSAGE */}
...
const styles = StyleSheet.create({
    ...
    buttonViewStyle: { alignItems: 'center', paddingVertical: 5  , justifyContent:'space-evenly'}
})
